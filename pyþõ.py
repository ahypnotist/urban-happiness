...
title = input("what is the title of this text?")
...
c = w.lower()
#c exists to turn w into lowercase, to check if its the same lower or not
if c == w:
    y = w
...
if de == "ENCODE":
    x = re.findall(
        r"is|as|us|es|os|and|of|ph|sh|that|the|ing|ar|ir|or|ur|ssi|ng|aa|ee|ii|oo|uu|ll|ed|ck|ch|qu|an|en|in|un|on|wh"
...
f.write(f"{title} {percent2} {de} {lc} \n")
f.close()
